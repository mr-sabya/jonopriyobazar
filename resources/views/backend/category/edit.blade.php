                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <input type="text" class="form-control" placeholder="slug" id="slug" name="slug" title="Please enter slug" value="{{ $category->slug }}">
                                    @if ($errors->has('slug'))
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <input type="file" name="icon" id="icon" data-max-file-size="200K" data-height="190" @if($category->icon != null)data-default-file="{{ url('upload/images', $category->icon)}}" @endif>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <input type="file" name="image" id="image" data-max-file-size="200K" data-height="190" @if($category->image != null)data-default-file="{{ url('upload/images', $category->image)}}" @endif>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <select class="form-control" name="p_id" id="p_id">
                                        ...
                                        <option value="{{ $parent->id }}" {{ $category->p_id == $parent->id ? 'selected' : ''}}>{{ $parent->name }}</option>
                                        @foreach($parent->sub as $sub)
                                        <option value="{{ $sub->id }}" {{ $category->p_id == $sub->id ? 'selected' : ''}}>-- {{ $sub->name }}</option>
                                        @endforeach
                                        @endforeach
                                    </select>
                                    @if ($errors->has('p_id'))
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-float">
                                    ...
                                    <div class="checkbox">
                                        <input id="is_home" type="checkbox" name="is_home" value="1" {{ $category->is_home == 1 ? 'checked' : ''}}>
