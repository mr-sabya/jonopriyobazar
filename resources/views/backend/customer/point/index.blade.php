...
<div class="container-fluid customer">
    ...
    <div class="row clearfix">
            ...
            <div class="card">
                <div class="body text-center">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="p-0 m-0">Point<br><strong><span id="total_purchase">{{ $user->point }}</span></strong></h4>
                        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Point</strong> History </h2>
                </div>
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="point_table">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th>Date</th>
...
<script>
    ...
    $('#point_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "/control/user/point/history/"+user_id,
        },
        columns: [
        {
            data: 'DT_RowIndex',
