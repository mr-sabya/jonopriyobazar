...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="header">
                    <h2><strong><i class="zmdi zmdi-chart"></i> Today's</strong> Order</h2>
                </div>
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Product</td>
                            <td>{{ $today_order->where('type', 'product')->count()}}</td>
                            <td>{{ $today_order->where('type', 'product')->where('status', 3)->count()}}</td>
                            <td>{{ $today_order->where('type', 'product')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Custom</td>
                            <td>{{ $today_order->where('type', 'custom')->count()}}</td>
                            <td>{{ $today_order->where('type', 'custom')->where('status', 3)->count()}}</td>
                            <td>{{ $today_order->where('type', 'custom')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Medicine</td>
                            <td>{{ $today_order->where('type', 'medicine')->count()}}</td>
                            <td>{{ $today_order->where('type', 'medicine')->where('status', 3)->count()}}</td>
                            <td>{{ $today_order->where('type', 'medicine')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Electricity Bill</td>
                            <td>{{ $today_order->where('type', 'electricity')->count()}}</td>
                            <td>{{ $today_order->where('type', 'electricity')->where('status', 3)->count()}}</td>
                            <td>{{ $today_order->where('type', 'electricity')->where('status', 4)->count()}}</td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="header">
                    <h2><strong><i class="zmdi zmdi-chart"></i> Monthly</strong> Order</h2>
                </div>
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Product</td>
                            <td>{{ $month_order->where('type', 'product')->count()}}</td>
                            <td>{{ $month_order->where('type', 'product')->where('status', 3)->count()}}</td>
                            <td>{{ $month_order->where('type', 'product')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Custom</td>
                            <td>{{ $month_order->where('type', 'custom')->count()}}</td>
                            <td>{{ $month_order->where('type', 'custom')->where('status', 3)->count()}}</td>
                            <td>{{ $month_order->where('type', 'custom')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Medicine</td>
                            <td>{{ $month_order->where('type', 'medicine')->count()}}</td>
                            <td>{{ $month_order->where('type', 'medicine')->where('status', 3)->count()}}</td>
                            <td>{{ $month_order->where('type', 'medicine')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Electricity Bill</td>
                            <td>{{ $month_order->where('type', 'electricity')->count()}}</td>
                            <td>{{ $month_order->where('type', 'electricity')->where('status', 3)->count()}}</td>
                            <td>{{ $month_order->where('type', 'electricity')->where('status', 4)->count()}}</td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="header">
                    <h2><strong><i class="zmdi zmdi-chart"></i> Total</strong> Order</h2>
                </div>
                ...
                <div class="body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Product</td>
                            <td>{{ $orders->where('type', 'product')->count()}}</td>
                            <td>{{ $orders->where('type', 'product')->where('status', 3)->count()}}</td>
                            <td>{{ $orders->where('type', 'product')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Custom</td>
                            <td>{{ $orders->where('type', 'custom')->count()}}</td>
                            <td>{{ $orders->where('type', 'custom')->where('status', 3)->count()}}</td>
                            <td>{{ $orders->where('type', 'custom')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Medicine</td>
                            <td>{{ $orders->where('type', 'medicine')->count()}}</td>
                            <td>{{ $orders->where('type', 'medicine')->where('status', 3)->count()}}</td>
                            <td>{{ $orders->where('type', 'medicine')->where('status', 4)->count()}}</td>
                        </tr>
                        <tr>
                            <td>Electricity Bill</td>
                            <td>{{ $orders->where('type', 'electricity')->count()}}</td>
                            <td>{{ $orders->where('type', 'electricity')->where('status', 3)->count()}}</td>
                            <td>{{ $orders->where('type', 'electricity')->where('status', 4)->count()}}</td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card mcard_4">
                <div class="body">
                    ...
                    <div class="img">
                        <img src="{{ url('backend/images/lg/avatar1.jpg') }}" class="rounded-circle" alt="profile-image">
                    </div>
                    <div class="user">
                ...
                <div class="body">
                    <div class="chat-widget">
                        <ul class="list-unstyled">
                            <li class="left">
                                <img src="{{ url('backend/images/xs/avatar3.jpg') }}" class="rounded-circle" alt="">
                            ...
                            <li class="left">
                                <img src="{{ url('backend/images/xs/avatar2.jpg') }}" class="rounded-circle" alt="">
                                <ul class="list-unstyled chat_info">
                            ...
                            <li class="left">
                                <img src="{{ url('backend/images/xs/avatar5.jpg') }}" class="rounded-circle" alt="">
                                <ul class="list-unstyled chat_info">
