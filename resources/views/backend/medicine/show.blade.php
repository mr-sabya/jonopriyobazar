            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="order-info">
                        <h3>Medicine Order: #{{ $order->invoice }}</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            @if($order->image !=  '')
                            <div class="list border p-3 mt-5">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="update_form" action="{{ route('admin.medicine.update')}}" method="post">
                                @csrf
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="payment_form" action="{{ route('admin.medicine.updatepayment')}}" method="post">
                                @csrf
                                <input type="hidden" name="order_id" value="{{ $order->id }}">
                                <div class="form-group">
