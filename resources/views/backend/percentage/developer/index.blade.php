...
<div class="modal fade" id="withdraw_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content position-relative">
            ...
            <form id="withdraw_form" method="post" action="{{ route('admin.developerwithdraw.store')}}">
                @csrf
...
<script>
    ...
    $('#percentage_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('admin.developer.fetch') }}",
        },
        columns: [
        {
            data: 'DT_RowIndex',
    ...
    $('#withdraw_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('admin.developerwithdraw.fetch') }}",
        },
        columns: [
        {
            data: 'DT_RowIndex',
    ...
    $(document).on('click', '.delete', function () {
        ...
        $('#ok_button').click(function () {
            $.ajax({
                url: "/control/developer/withdraw/" + withdraw_id,
                method: "DELETE",
                beforeSend: function () {
