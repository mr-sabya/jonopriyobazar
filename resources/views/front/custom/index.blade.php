...
<div class="main_content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="custom-order-title">
                        ...
                        <p>কাস্টম অর্ডার ফরমের মাধ্যমে আপনার বাজার লিস্ট লিখে কিংবা বাজার লিস্ট এর ছবি আপলোড করে অর্ডার করতে পারবেন দ্রুত।</p>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <form action="{{ route('custom.order.store')}}" id="custom_order_form" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @if(!$shipping_address)
                                    <div class="card">
                                        <div class="card-body">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label>Bazar List</label>
                                                        <textarea class="form-control" name="custom" id="custom" placeholder="Enter your bazar list in serial (1, 2, 3) with quantity.." rows="5" cols="60"></textarea>
                                                    </div>
    ...
    <script>
        ...
        $('#custom').summernote({
            placeholder: 'Enter your bazar list in serial (1, 2, 3) with quantity..',
            height: 200,
            toolbar: false,
            callbacks: {
                onKeyup: function(e) {
