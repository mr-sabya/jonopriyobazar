                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 pt-3">
                                    ...
                                    <div class="profile-card mt-3 p-3">
                                        <form id="address_form" action="{{ route('user.address.update')}}" method="post">
                                            @csrf
                                            ...
                                            <div class="form-row border-bottom mb-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="phone" id="address_phone" class="form-control" value="{{ $address->phone }}">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="street" name="street" placeholder="House no.1, Road no. 1, Sonadanga" value="{{ $address->street }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="thana_id" id="thana_id" class="form-control">
                                                            <option value="{{ $address->thana_id }}" selected>{{ $address->thana['name']}}</option>
                                                        </select>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="post_code" name="post_code" placeholder="Enter post code" value="{{ $address->post_code }}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="middle">
                                                        <label>
                                                            <input value="home" type="radio" name="type" {{ $address->type == 'home' ? 'checked' : ''}}/>
                                                        ...
                                                        <label>
                                                          <input value="office" type="radio" name="type" {{ $address->type == 'office' ? 'checked' : ''}}/>
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.thana == ''){
                    ...
                    $('#city_id').html('');
                    $('#city_id').append('<option value="" selected disabled>(Select City/Area)</option>');
