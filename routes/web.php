...
Route::post('custom-order/submit', [CustomOrderController::class, 'store'])->name('custom.order.store');
...
// Common Utility
Route::get('get-thana/{id}', [CommonController::class, 'getThana']);
Route::get('get-city/{id}', [CommonController::class, 'getCity']);
